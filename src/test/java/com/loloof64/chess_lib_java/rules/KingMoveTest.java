...
public class KingMoveTest {
    ...
    public void castleMoveGeneratesPositionCorrectly(){
        ...
        assertEquals(Position.fromFEN("rnbq1rk1/ppp2ppp/3p1n2/2b1p3/4P3/2NPB3/PPPQ1PPP/2KR1BNR b - - 1 6").right(),
                wrapPos4.right().position);
        assertEquals("O-O-O", wrapPos4.right().moveSan);
        ...
        assertEquals("O-O", wrapPos6.right().moveSan);
        ...
        assertEquals("O-O-O", wrapPos8.right().moveSan);
    }
    ...
    public void weCannotCastleWhenTheKingIsInChess(){
        ...
        Either<Exception, MoveResult> wrapPos4 = pos3.move(new Move(BoardCell.E8, BoardCell.G8));
        ...
        Either<Exception, MoveResult> wrapPos6 = pos5.move(new Move(BoardCell.E1, BoardCell.C1));
    ...
    public void weCannotCastleWhenTheKingGoesAcrossAttackedCells(){
        ...
        Either<Exception, MoveResult> wrapPos10 = pos9.move(new Move(BoardCell.E1, BoardCell.G1));
        ...
        Either<Exception, MoveResult> wrapPos12 = pos11.move(new Move(BoardCell.E8, BoardCell.C8));
