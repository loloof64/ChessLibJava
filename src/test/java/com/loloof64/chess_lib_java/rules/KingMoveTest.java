...
public class KingMoveTest {
    ...
    public void kingCanMoveOneCellTowardsAllDirections(){
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.C6)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.F3)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.D6)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.D1)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.B4)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.H4)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.H8)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.B2)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.B6)));
        assertFalse(pos3.canMove(new Move(BoardCell.D4, BoardCell.G1)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.C5)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.D5)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.E5)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.C4)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.E4)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.C3)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.D3)));
        assertTrue(pos3.canMove(new Move(BoardCell.D4, BoardCell.E3)));

        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.C6)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.F3)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.D6)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.D1)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.B4)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.H4)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.H8)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.B2)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.B6)));
        assertFalse(pos4.canMove(new Move(BoardCell.D4, BoardCell.G1)));
        assertTrue(pos4.canMove(new Move(BoardCell.D4, BoardCell.C5)));
        assertTrue(pos4.canMove(new Move(BoardCell.D4, BoardCell.D5)));
        assertTrue(pos4.canMove(new Move(BoardCell.D4, BoardCell.E5)));
        assertTrue(pos4.canMove(new Move(BoardCell.D4, BoardCell.C4)));
        assertTrue(pos4.canMove(new Move(BoardCell.D4, BoardCell.E4)));
    ...
    public void kingCaptureEnemyPieceIfOnItsTargetCellButNotHisFriendPiece(){
        assertTrue(pos1.canMove(new Move(BoardCell.D4, BoardCell.C5)));
        assertTrue(pos1.canMove(new Move(BoardCell.D4, BoardCell.E5)));
        assertTrue(pos1.canMove(new Move(BoardCell.D4, BoardCell.C3)));
        assertTrue(pos1.canMove(new Move(BoardCell.D4, BoardCell.E3)));
        assertFalse(pos1.canMove(new Move(BoardCell.D4, BoardCell.D5)));
        assertFalse(pos1.canMove(new Move(BoardCell.D4, BoardCell.D3)));
        assertFalse(pos1.canMove(new Move(BoardCell.D4, BoardCell.C4)));
        assertFalse(pos1.canMove(new Move(BoardCell.D4, BoardCell.E4)));

        assertTrue(pos2.canMove(new Move(BoardCell.D4, BoardCell.C5)));
        assertTrue(pos2.canMove(new Move(BoardCell.D4, BoardCell.E5)));
        assertTrue(pos2.canMove(new Move(BoardCell.D4, BoardCell.C3)));
        assertTrue(pos2.canMove(new Move(BoardCell.D4, BoardCell.E3)));
        assertFalse(pos2.canMove(new Move(BoardCell.D4, BoardCell.D5)));
        assertFalse(pos2.canMove(new Move(BoardCell.D4, BoardCell.D3)));
        assertFalse(pos2.canMove(new Move(BoardCell.D4, BoardCell.C4)));
        assertFalse(pos2.canMove(new Move(BoardCell.D4, BoardCell.E4)));

        assertTrue(pos5.canMove(new Move(BoardCell.D4, BoardCell.D5)));
        assertTrue(pos5.canMove(new Move(BoardCell.D4, BoardCell.D3)));
        assertTrue(pos5.canMove(new Move(BoardCell.D4, BoardCell.C4)));
        assertTrue(pos5.canMove(new Move(BoardCell.D4, BoardCell.E4)));
        assertFalse(pos5.canMove(new Move(BoardCell.D4, BoardCell.C5)));
        assertFalse(pos5.canMove(new Move(BoardCell.D4, BoardCell.E5)));
        assertFalse(pos5.canMove(new Move(BoardCell.D4, BoardCell.C3)));
        assertFalse(pos5.canMove(new Move(BoardCell.D4, BoardCell.E3)));

        assertTrue(pos6.canMove(new Move(BoardCell.D4, BoardCell.D5)));
        assertTrue(pos6.canMove(new Move(BoardCell.D4, BoardCell.D3)));
        assertTrue(pos6.canMove(new Move(BoardCell.D4, BoardCell.C4)));
        assertTrue(pos6.canMove(new Move(BoardCell.D4, BoardCell.E4)));
        assertFalse(pos6.canMove(new Move(BoardCell.D4, BoardCell.C5)));
    ...
    public void kingCanDoQueenSideCastleIfFeatureAvailableAndPathFree(){
        ...
        assertFalse(pos8.canMove(new Move(BoardCell.E8, BoardCell.C8)));

        Position pos9 = Position.fromFEN("rnbq1rk1/ppp1bppp/3p1n2/4p1B1/4P3/2NP4/PPPQ1PPP/R3KBNR w K - 4 6").right();
        assertFalse(pos9.canMove(new Move(BoardCell.E1, BoardCell.C1)));
    ...
    public void kingMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.E1, BoardCell.F2));
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(new Move(BoardCell.E8, BoardCell.F7));
    ...
    public void kingMoveClearsEnPassantFile(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.E1, BoardCell.E2));
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(new Move(BoardCell.E8, BoardCell.E7));
    ...
    public void castleMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(new Move(BoardCell.E1, BoardCell.C1));
        ...
        Either<Exception, Position> wrapPos6 = pos5.move(new Move(BoardCell.E8, BoardCell.G8));
