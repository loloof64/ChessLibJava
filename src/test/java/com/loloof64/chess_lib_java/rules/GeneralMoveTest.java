...
public class GeneralMoveTest {
    ...
    public void cannotMoveFromAnEmptyCell(){
        Position pos1 = Position.fromFEN("3rr2k/1bq3pp/p2p1n2/np6/5N2/PB5Q/1PPB2PP/1K1R1R2 w - - 0 1").fromJust();
        assertEquals(false, pos1.canMove(BoardCell.E6, BoardCell.F7));

        Position pos2 = Position.fromFEN("3rr2k/1bq3pp/p2p1n2/np6/5N2/PB5Q/1PPB2PP/1K1R1R2 b - - 0 1").fromJust();
    ...
    public void illegalPseudoMoveGeneratesNothing(){
        Position pos1 = Position.fromFEN("rnbqkb1r/pppppppp/5n2/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 1 2").fromJust();
        ...
        Position pos4 = Position.fromFEN("rnbqkb1r/pppppppp/5n2/4P3/8/8/PPPP1PPP/RNBQKBNR b KQkq - 0 2").fromJust();
    ...
    public void kingIsInChess(){
        Position pos1 = Position.fromFEN("rn1qkb1r/ppp2Bpp/3p1n2/4N3/4P3/2N5/PPPP1PPP/R1BbK2R b KQkq - 0 6").fromJust();
        assertEquals(true, pos1.kingIsInChess(false));

        Position pos2 = Position.fromFEN("rnb1kbnr/ppNp1pp1/7p/4p3/4P2q/8/PPPP1PPP/R1BQKBNR b KQkq - 0 4").fromJust();
        assertEquals(true, pos2.kingIsInChess(false));

        Position pos3 = Position.fromFEN("rnbqkb1r/pppppppp/7n/1B6/4P3/8/PPPP1PPP/RNBQK1NR b KQkq - 2 2").fromJust();
        assertEquals(false, pos3.kingIsInChess(false));

        Position pos4 = Position.fromFEN("rnb1kbnr/ppp1pppp/4q3/8/8/2N5/PPPP1PPP/R1BQKBNR w KQkq - 2 4").fromJust();
        assertEquals(true, pos4.kingIsInChess(true));

        Position pos5 = Position.fromFEN("rnbqk1nr/pppp1ppp/8/4N3/1b6/8/PPPPPPPP/RNBQKB1R w KQkq - 1 3").fromJust();
        assertEquals(false, pos5.kingIsInChess(true));
    }

    @Test
    public void weCannotDoAMoveThatWouldLeaveOurKingInChess(){
        Position pos1 = Position.fromFEN("8/8/4k3/8/4K3/8/8/8 w - - 0 1").fromJust();
        Maybe<Position> wrapPos2 = pos1.move(BoardCell.E4, BoardCell.D5);
        assertEquals(true, wrapPos2.isNothing());

        Position pos3 = Position.fromFEN("8/8/4k3/8/4K3/8/8/8 b - - 0 1").fromJust();
        Maybe<Position> wrapPos4 = pos3.move(BoardCell.E6, BoardCell.E5);
        assertEquals(true, wrapPos4.isNothing());

        Position pos5 = Position.fromFEN("4k3/8/8/8/8/8/2q5/4K3 w - - 0 1").fromJust();
        Maybe<Position> wrapPos6 = pos5.move(BoardCell.E1, BoardCell.D2);
        assertEquals(true, wrapPos6.isNothing());

        Position pos7 = Position.fromFEN("4k3/8/8/5Q2/8/8/8/4K3 b - - 0 1").fromJust();
        Maybe<Position> wrapPos8 = pos7.move(BoardCell.E8, BoardCell.F7);
        assertEquals(true, wrapPos8.isNothing());

        Position pos9 = Position.fromFEN("r1bqkbnr/ppp2ppp/2np4/1B2p3/4P3/3P1N2/PPP2PPP/RNBQK2R b KQkq - 0 4").fromJust();
        Maybe<Position> wrapPos10 = pos9.move(BoardCell.C6, BoardCell.D4);
        assertEquals(true, wrapPos10.isNothing());

        Position pos11 = Position.fromFEN("rnbqk1nr/ppp2ppp/4p3/3p4/1b1P4/2N2N2/PPP1PPPP/R1BQKB1R w KQkq - 2 4").fromJust();
