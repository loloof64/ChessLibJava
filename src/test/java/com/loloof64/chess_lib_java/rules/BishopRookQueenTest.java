...
public class BishopRookQueenTest {
    ...
    public void bishopCanMoveInDiagonalAndAwayIfNoObstacle(){
        ...
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.B3));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.E6));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.B4));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.G4));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.D7));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.D3));
        assertTrue(pos1.canMove(BoardCell.D4,BoardCell.B2));
        assertTrue(pos1.canMove(BoardCell.D4,BoardCell.H8));
        assertTrue(pos1.canMove(BoardCell.D4,BoardCell.E3));
        assertTrue(pos1.canMove(BoardCell.D4,BoardCell.A7));

        Position pos2 = Position.fromFEN("4k3/8/8/8/4b3/8/8/4K3 b - - 0 1").right();
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.G5));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.C3));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.E6));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.E3));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.A4));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.G4));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.G6));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.B1));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.A8));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.F3));
    }
    ...
    public void bishopCanCaptureEnemyPieceIfOnItsPathButNotFriendPiece(){
        ...
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.G6));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.B1));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.A8));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.G2));

        Position pos2 = Position.fromFEN("n3k3/8/6N1/8/4b3/8/6p1/1B2K3 b - - 0 1").right();
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.G6));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.B1));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.A8));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.G2));
    }
    ...
    public void bishopCannotJumpOverObstacles(){
        ...
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.A8));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.G2));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.B1));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.G6));

        Position pos2 = Position.fromFEN("7r/4k3/1R3n2/8/3b4/2r5/5N2/b3K3 b - - 0 1").right();
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.A1));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.H8));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.A7));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.G1));
    }
    ...
    public void rookCanMoveHorizontallyOrVerticallyIfNoObstacle(){
        ...
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.C6));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.F3));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.G7));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.C3));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.A7));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.G1));
        assertTrue(pos1.canMove(BoardCell.D4, BoardCell.C4));
        assertTrue(pos1.canMove(BoardCell.D4, BoardCell.H4));
        assertTrue(pos1.canMove(BoardCell.D4, BoardCell.D2));
        assertTrue(pos1.canMove(BoardCell.D4, BoardCell.D7));

        Position pos2 = Position.fromFEN("4k3/8/8/8/3r4/8/8/4K3 b - - 0 1").right();
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.C6));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.F3));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.G7));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.C3));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.A7));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.G1));
        assertTrue(pos2.canMove(BoardCell.D4, BoardCell.C4));
        assertTrue(pos2.canMove(BoardCell.D4, BoardCell.H4));
        assertTrue(pos2.canMove(BoardCell.D4, BoardCell.D2));
        assertTrue(pos2.canMove(BoardCell.D4, BoardCell.D7));
    }
    ...
    public void rookCanCaptureEnemyPieceIfOnItsTargetSquareButNotFriendPiece(){
        ...
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.D2));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.G4));
        assertTrue(pos1.canMove(BoardCell.D4, BoardCell.A4));
        assertTrue(pos1.canMove(BoardCell.D4, BoardCell.D8));

        Position pos2 = Position.fromFEN("3bk3/8/8/8/n2r2B1/8/3N4/4K3 b - - 0 1").right();
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.A4));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.D8));
        assertTrue(pos2.canMove(BoardCell.D4, BoardCell.D2));
        assertTrue(pos2.canMove(BoardCell.D4, BoardCell.G4));
    }

    @Test
    public void rookCannotJumpOverObstacles(){
        Position pos1 = Position.fromFEN("3bk3/3R4/8/8/nN1R1n2/3P4/8/4K3 w - - 0 1").right();
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.A4));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.G4));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.D8));
        assertFalse(pos1.canMove(BoardCell.D4, BoardCell.D2));

        Position pos2 = Position.fromFEN("3Bk3/3R4/8/8/BN1r1n2/3P4/8/4K3 b - - 0 1").right();
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.A4));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.G4));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.D8));
        assertFalse(pos2.canMove(BoardCell.D4, BoardCell.D2));
    }
    ...
    public void queenCanMoveEitherAsRookOrBishop(){
        ...
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.E3));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.C2));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.C4));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.F3));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.F4));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.C6));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.E5));
        assertTrue(pos1.canMove(BoardCell.E4, BoardCell.H7));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.A4));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.B7));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.E7));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.H1));
        assertFalse(pos1.canMove(BoardCell.E4, BoardCell.G4));

        Position pos2 = Position.fromFEN("4k3/1n6/4B3/8/1N2q1nN/4p3/2P5/4K3 b - - 0 1").right();
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.D3));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.H7));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.B4));
        assertTrue(pos2.canMove(BoardCell.E4, BoardCell.E6));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.E3));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.E2));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.H4));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.B7));
        assertFalse(pos2.canMove(BoardCell.E4, BoardCell.A8));
    }
    ...
    public void bishopMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(BoardCell.D4, BoardCell.B2);
        Position pos2 = wrapPos2.right();
        assertEquals(Position.fromFEN("4k3/8/5n2/8/8/8/1B6/4K3 b - - 1 1").right(), pos2);
        Either<Exception, Position> wrapPos3 = pos1.move(BoardCell.D4, BoardCell.F6);
        ...
        Either<Exception, Position> wrapPos5 = pos4.move(BoardCell.D4, BoardCell.A1);
        Position pos5 = wrapPos5.right();
        assertEquals(Position.fromFEN("4k3/8/8/4N3/8/8/8/b3K3 w - - 1 2").right(), pos5);
        Either<Exception, Position> wrapPos6 = pos4.move(BoardCell.D4, BoardCell.E5);
    ...
    public void bishopMoveClearsEnPassantFile(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(BoardCell.F1, BoardCell.C4);
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(BoardCell.F8, BoardCell.B4);
    ...
    public void rookMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(BoardCell.C4, BoardCell.C7);
        Position pos2 = wrapPos2.right();
        assertEquals(Position.fromFEN("4k3/2R5/8/8/6n1/8/8/4K3 b - - 1 1").right(), pos2);
        Either<Exception, Position> wrapPos3 = pos1.move(BoardCell.C4, BoardCell.G4);
        Position pos3 = wrapPos3.right();
        ...
        Either<Exception, Position> wrapPos5 = pos4.move(BoardCell.C4, BoardCell.G4);
        Position pos5 = wrapPos5.right();
        assertEquals(Position.fromFEN("4k3/8/8/8/6r1/8/8/4K3 w - - 0 2").right(), pos5);
        Either<Exception, Position> wrapPos6 = pos4.move(BoardCell.C4, BoardCell.C7);
        Position pos6 = wrapPos6.right();
    ...
    public void rookMoveClearsEnPassantFile(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(BoardCell.H1, BoardCell.H3);
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(BoardCell.H8, BoardCell.H6);
    ...
    public void a1h1a8Orh8RookMoveCancelCastlesAccordinglyInGeneratedPosition(){
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(BoardCell.A1, BoardCell.A3);
        ...
        Either<Exception, Position> wrapPos6 = pos5.move(BoardCell.H8, BoardCell.H6);
        Position pos6 = wrapPos6.right();
        ...
        Either<Exception, Position> wrapPos8 = pos7.move(BoardCell.A8, BoardCell.A6);
    ...
    public void queenMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(BoardCell.B4, BoardCell.B7);
        assertEquals(Position.fromFEN("4k3/1Q6/8/8/8/8/8/4K3 b - - 0 1").right(), wrapPos2.right());
        Either<Exception, Position> wrapPos3 = pos1.move(BoardCell.B4, BoardCell.D2);
        assertEquals(Position.fromFEN("4k3/1b6/8/8/8/8/3Q4/4K3 b - - 1 1").right(), wrapPos3.right());

        Position pos4 = Position.fromFEN("4k3/8/1B5q/8/8/8/8/4K3 b - - 1 1").right();
        Either<Exception, Position> wrapPos5 = pos4.move(BoardCell.H6, BoardCell.B6);
        assertEquals(Position.fromFEN("4k3/8/1q6/8/8/8/8/4K3 w - - 0 2").right(), wrapPos5.right());
        Either<Exception, Position> wrapPos6 = pos4.move(BoardCell.H6, BoardCell.C1);
        assertEquals(Position.fromFEN("4k3/8/1B6/8/8/8/8/2q1K3 w - - 2 2").right(), wrapPos6.right());
    }

    @Test
    public void queenMoveClearsEnPassantFile(){
        Position pos1 = Position.fromFEN("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2").right();
        Either<Exception, Position> wrapPos2 = pos1.move(BoardCell.D1, BoardCell.H5);
        assertEquals(Position.fromFEN("rnbqkbnr/pppp1ppp/8/4p2Q/4P3/8/PPPP1PPP/RNB1KBNR b KQkq - 1 2").right(),
                wrapPos2.right());

        Position pos3 = Position.fromFEN("rnbqkbnr/pppp1ppp/8/4p3/3PP3/8/PPP2PPP/RNBQKBNR b KQkq d3 0 2").right();
        Either<Exception, Position> wrapPos4 = pos3.move(BoardCell.D8, BoardCell.H4);
