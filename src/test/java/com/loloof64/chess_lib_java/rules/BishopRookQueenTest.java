...
public class BishopRookQueenTest {
    ...
    public void bishopMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.D4, BoardCell.B2));
        Position pos2 = wrapPos2.right();
        assertEquals(Position.fromFEN("4k3/8/5n2/8/8/8/1B6/4K3 b - - 1 1").right(), pos2);
        Either<Exception, Position> wrapPos3 = pos1.move(new Move(BoardCell.D4, BoardCell.F6));
        ...
        Either<Exception, Position> wrapPos5 = pos4.move(new Move(BoardCell.D4, BoardCell.A1));
        Position pos5 = wrapPos5.right();
        assertEquals(Position.fromFEN("4k3/8/8/4N3/8/8/8/b3K3 w - - 1 2").right(), pos5);
        Either<Exception, Position> wrapPos6 = pos4.move(new Move(BoardCell.D4, BoardCell.E5));
    ...
    public void bishopMoveClearsEnPassantFile(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.F1, BoardCell.C4));
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(new Move(BoardCell.F8, BoardCell.B4));
    ...
    public void rookMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.C4, BoardCell.C7));
        Position pos2 = wrapPos2.right();
        assertEquals(Position.fromFEN("4k3/2R5/8/8/6n1/8/8/4K3 b - - 1 1").right(), pos2);
        Either<Exception, Position> wrapPos3 = pos1.move(new Move(BoardCell.C4, BoardCell.G4));
        Position pos3 = wrapPos3.right();
        ...
        Either<Exception, Position> wrapPos5 = pos4.move(new Move(BoardCell.C4, BoardCell.G4));
        Position pos5 = wrapPos5.right();
        assertEquals(Position.fromFEN("4k3/8/8/8/6r1/8/8/4K3 w - - 0 2").right(), pos5);
        Either<Exception, Position> wrapPos6 = pos4.move(new Move(BoardCell.C4, BoardCell.C7));
        Position pos6 = wrapPos6.right();
    ...
    public void rookMoveClearsEnPassantFile(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.H1, BoardCell.H3));
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(new Move(BoardCell.H8, BoardCell.H6));
    ...
    public void a1h1a8Orh8RookMoveCancelCastlesAccordinglyInGeneratedPosition(){
        ...
        Either<Exception, Position> wrapPos4 = pos3.move(new Move(BoardCell.A1, BoardCell.A3));
        ...
        Either<Exception, Position> wrapPos6 = pos5.move(new Move(BoardCell.H8, BoardCell.H6));
        Position pos6 = wrapPos6.right();
        ...
        Either<Exception, Position> wrapPos8 = pos7.move(new Move(BoardCell.A8, BoardCell.A6));
    ...
    public void queenMoveGeneratesPositionCorrectly(){
        ...
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.B4, BoardCell.B7));
        assertEquals(Position.fromFEN("4k3/1Q6/8/8/8/8/8/4K3 b - - 0 1").right(), wrapPos2.right());
        Either<Exception, Position> wrapPos3 = pos1.move(new Move(BoardCell.B4, BoardCell.D2));
        ...
        Either<Exception, Position> wrapPos5 = pos4.move(new Move(BoardCell.H6, BoardCell.B6));
        assertEquals(Position.fromFEN("4k3/8/1q6/8/8/8/8/4K3 w - - 0 2").right(), wrapPos5.right());
        Either<Exception, Position> wrapPos6 = pos4.move(new Move(BoardCell.H6, BoardCell.C1));
    ...
    public void queenMoveClearsEnPassantFile(){
        Position pos1 = Position.fromFEN("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2").right();
        Either<Exception, Position> wrapPos2 = pos1.move(new Move(BoardCell.D1, BoardCell.H5));
        assertEquals(Position.fromFEN("rnbqkbnr/pppp1ppp/8/4p2Q/4P3/8/PPPP1PPP/RNB1KBNR b KQkq - 1 2").right(),
                wrapPos2.right());

        Position pos3 = Position.fromFEN("rnbqkbnr/pppp1ppp/8/4p3/3PP3/8/PPP2PPP/RNBQKBNR b KQkq d3 0 2").right();
        Either<Exception, Position> wrapPos4 = pos3.move(new Move(BoardCell.D8, BoardCell.H4));
